...
void setDeepDarkStyle()
{
    ...
    colors[ImGuiCol_ScrollbarGrabActive]    = ImVec4(0.20f, 0.22f, 0.23f, 1.00f);
...
// ImVec4(0.87f, 0.88f, 0.90f, 1.00f) grey
// ImVec4(0.72f, 0.70f, 0.65f, 1.00f) grey brown
...
void setLightStyle()
{
    ...
    colors[ImGuiCol_FrameBgActive]          = ImVec4(0.06f, 0.42f, 0.42f, 1.00f);
    colors[ImGuiCol_FrameBgHovered]         = ImVec4(0.86f, 0.86f, 0.86f, 0.80f);
    ...
    colors[ImGuiCol_SeparatorActive]        = ImVec4(0.92f, 0.92f, 0.92f, 1.00f);
    colors[ImGuiCol_SeparatorHovered]       = ImVec4(0.92f, 0.92f, 0.92f, 1.00f);
    ...
    colors[ImGuiCol_Button]                 = ImVec4(0.49f, 0.78f, 0.72f, 1.00f);
    colors[ImGuiCol_ButtonActive]           = ImVec4(0.49f, 0.78f, 0.72f, 1.00f);
    colors[ImGuiCol_ButtonHovered]          = ImVec4(0.36f, 0.72f, 0.64f, 1.00f);
    ...
    colors[ImGuiCol_ResizeGrip]             = ImVec4(0.95f, 0.95f, 0.95f, 1.00f);
