...
namespace ImGui
{
	...
	protected:
		...
		bool show1DPadSlider(char const* label, double* value, const double* min, const double* max, const ImRect& bb, const ImRect& containerBB, ImRect& grabBB, const ImGuiID& id, ImGuiWindow* window, ImGuiSliderFlags flags=NULL);
